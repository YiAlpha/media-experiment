...
control_means <- with(
	...
	c(
		"Control Mean",
		round(mean(involve_parents[female == 1 &
															 	IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(involve_parents_ml[female == 1 &
																		IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(involve_nabakyala[female == 1 &
																 	IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(involve_nabakyala_ml[female == 1 &
																			IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(involve_lc1[female == 1 &
													 	IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(involve_lc1_ml[female == 1 &
																IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(report_police[female == 1 &
														 	IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(report_police_ml[female == 1 &
																	IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(intervene_index[female == 1 &
															 	IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2),
		round(mean(intervene_index_ml[female == 1 &
																		IPV == 0 & respondent_category == "Complier"], na.rm = TRUE), 2)
	)
)
...
sink("03_tables/reporting_attitudes_women.tex")
stargazer(
	... = list(
	...
	p = list(
		...
		intervene_index_ml$ri_pvals,
		intervene_index_el$ri_pvals
	),
	se = list(
