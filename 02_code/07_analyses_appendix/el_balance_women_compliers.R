...
el_w_comp <- subset(el, female == 1 & complier)
...
names(baltab_conditional) <- sort(unique(el_w_comp$treatment))
...
sink("03_tables/balance_conditional_women_comp_el.tex")
print(
