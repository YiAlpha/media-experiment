...
control_means <- with(
  ...
  c(
    "Control Mean",
    round(mean(violence_disapproval_ml[female == 1 & IPV == 0 & respondent_category == "Complier"],na.rm = TRUE), 2),
    round(mean(violence_disapproval[female == 1 & IPV == 0 & respondent_category == "Complier"],na.rm = TRUE), 2),
    round(mean(empathy_pair[female == 1 & IPV == 0 & respondent_category == "Complier"],na.rm = TRUE), 2),
    round(mean(spiral_risk[female == 1 & IPV == 0 & respondent_category == "Complier"],na.rm = TRUE), 2),
    round(mean(support_gender_equality_ml[female == 1 & IPV == 0 & respondent_category == "Complier"],na.rm = TRUE), 2),
    round(mean(support_gender_equality[female == 1 & IPV == 0 & respondent_category == "Complier"],na.rm = TRUE), 2)
...
sink("03_tables/table_coef_plot_women.tex")
stargazer(
  ... = list(
